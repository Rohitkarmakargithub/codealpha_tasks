...
export default function Carousel() {
    return (
        <div>
            <div id="carouselExampleIndicators" className="carousel slide carousel-fade" style={{objectFit:"contain !important"}}>
                ...
                <div className="carousel-captoin" style={{ zIndex: "2", width: "60%", position: "absolute", bottom: "40px", left: "50%", transform: "translateX(-50%)" }}>
